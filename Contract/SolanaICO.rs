...
declare_id!(process.env.NEXT_PUBLIC_PROGRAM_ID);
...
pub mod ico {
    ...
    pub const ICO_MINT_ADDRESS: &str = process.env.NEXT_PUBLIC_ICO_MINT_TOKEN;
    ...
    pub fn create_ico_ata(ctx: Context<CreateIcoATA>, ico_amount: u64) -> Result<()> {
        ...
        data.tokens_sold = 0;
        msg!("Initialized ICO data account");
        Ok(())
    }
    ...
    pub fn deposit_ico_in_ata(ctx: Context<DepositIcoInAta>, ico_amount: u64) -> Result<()> {
        ...
        msg!("Deposit {} additional tokens", ico_amount);
        Ok(())
    }
    ...
    pub fn buy_tokens(
        ...
        msg!("Transferred {} lamports from user to admin", sol_amount);
        ...
        msg!("Transfer {} token to buyer", token_amount);
        Ok(())
    }
    ...
    pub struct CreateIcoATA<'info> {
        ...
        #[account(address = ICO_MINT_ADDRESS.parse::<Pubkey>().unwrap())]
